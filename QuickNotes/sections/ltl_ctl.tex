...
\subsection{\CTLs}
    ...
    \]
    \begin{itemize}
    \item   The former says \Intuit{$\forall$ paths $\pi$ originating from
            $s_i$ such that $M, \pi \Entails \varphi$};
    \item   The latter says \Intuit{$\exists$ a path $\pi$ originating from
            $s_i$ such that $M, \pi \Entails \varphi$};
    \end{itemize}

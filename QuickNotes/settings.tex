...
\usepackage{enumitem}
\setdescription{style=sameline,leftmargin=.6in}
...
\newcommand{\Ef}[2]{\mathcal{\Op{E}}_{#2}{#1}}
\newcommand{\Af}[2]{\mathcal{\Op{A}}_{#2}{#1}}
...
\newcommand{\SymbDenot}[1]{\Symb{\Denot{{#1}}}}
...
\newcommand{\IterUnion}[3]{\bigcup_{#1}^{#2}\left({#3}\right)}
\newcommand{\IterIntersect}[3]{\bigcap_{#1}^{#2}\left({#3}\right)}
\newcommand{\lOr}{\vee}
...
\newcommand{\Fair}{\mathcal{{\tt fair}}}
\newcommand{\True}{\mathcal{{\tt true}}}
\newcommand{\False}{\mathcal{{\tt false}}}
